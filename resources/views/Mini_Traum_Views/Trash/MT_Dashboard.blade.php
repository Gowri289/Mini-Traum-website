...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" >
            ...
            <div class="row">
                <h3 >Welcome  <span style="color: blue"> {{$user_data->user_name}}</span> </h3>
                <h3> Email :  <span style="color: blue"> {{$user_data->user_email}}</span> </h3>
                <h3> You are a :  <span style="color: blue"> {{$user_data->user_type}}</span> </h3>
